workspace {
    ...
    // Define message types as constants to be used in tags
    //MES
    !constant OPERATION_ANNUL_MESTOERP "OPERATION_ANNUL_MESTOERP"
    !constant OPERATION_NEW_MESTOERP "OPERATION_NEW_MESTOERP"
    !constant OPERATION_CHANGE_MESTOERP "OPERATION_CHANGE_MESTOERP"
    !constant DELIVERY_REQUEST_MESTOERP "DELIVERY_REQUEST_MESTOERP"
    !constant OPERATION_REMOVE_MESTOERP "OPERATION_REMOVE_MESTOERP"
    !constant OPERATION_STATUS_CHANGE_MESTOERP "OPERATION_STATUS_CHANGE_MESTOERP"
    !constant TEST_MESTOERP "TEST_MESTOERP"
    !constant ERRORCODES_MESTOERP "ERRORCODES_MESTOERP"
    !constant OPERATION_ANNUL_CAN_MESTOERP "OPERATION_ANNUL_CAN_MESTOERP"
    !constant OPERATION_CANCEL_MESTOERP "OPERATION_CANCEL_MESTOERP"
    !constant OPERATION_REPORT_MESTOERP "OPERATION_REPORT_MESTOERP" 
    !constant SUBORDER_REQUEST_MESTOERP "SUBORDER_REQUEST_MESTOERP" 
    !constant WEIGHING_REQUEST_MESTOERP "WEIGHING_REQUEST_MESTOERP"
    //Other
    !constant MLS "MLS"
    !constant PLC_DATA "PLC_DATA"
